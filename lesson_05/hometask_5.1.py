...
filtered_cars = [ (brand, details) for brand, details in car_data.items()
...
for brand, details in sorted_cars[:5]:
    print(f"{brand}: color={details[0]}, year={details[1]}. engine={details[2]}, type={details[3]}, price={details[4]}")
